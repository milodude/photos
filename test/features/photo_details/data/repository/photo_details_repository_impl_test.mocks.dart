...
// in greisy_photos/test/features/photo_details/data/repository/photo_details_repository_impl_test.dart.
...
class _FakePhotoModel_2 extends _i1.SmartFake implements _i4.PhotoModel {
  _FakePhotoModel_2(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class MockPhotoDataSource extends _i1.Mock implements _i5.PhotoDataSource {
  ...
  _i6.Future<List<_i4.PhotoModel>> getPhotos() =>
      (super.noSuchMethod(Invocation.method(#getPhotos, []),
              returnValue:
                  _i6.Future<List<_i4.PhotoModel>>.value(<_i4.PhotoModel>[]))
          as _i6.Future<List<_i4.PhotoModel>>);
  @override
  _i6.Future<_i4.PhotoModel> getPhoto(String? photoId) => (super.noSuchMethod(
          Invocation.method(#getPhoto, [photoId]),
          returnValue: _i6.Future<_i4.PhotoModel>.value(
              _FakePhotoModel_2(this, Invocation.method(#getPhoto, [photoId]))))
      as _i6.Future<_i4.PhotoModel>);
}
