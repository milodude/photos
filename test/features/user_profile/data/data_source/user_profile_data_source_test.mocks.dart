...
// in greisy_photos/test/features/user_profile/data/data_source/user_profile_data_source_test.dart.
...
import 'package:greisy_photos/core/providers/url_provider.dart' as _i6;
...
class MockUrlProvider extends _i1.Mock implements _i6.UrlProvider {
  ...
  @override
  Uri getUrl(String? path, Map<String, dynamic>? params) => (super.noSuchMethod(
      Invocation.method(#getUrl, [path, params]),
      returnValue:
          _FakeUri_2(this, Invocation.method(#getUrl, [path, params]))) as Uri);
}
