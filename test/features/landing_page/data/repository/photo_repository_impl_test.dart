...
import 'package:greisy_photos/features/landing_page/data/repository/photo_repository_impl.dart';
...
void main() {
  ...
  PhotoRepositoryImpl photoRepositoryImpl =
      PhotoRepositoryImpl(photoDataSource: mockPhotoDataSource);
  ...
  group('PhotoRepositoryImpl: ', () {
    testWidgets('Should get a photo list', (tester) async {
      ...
      when(mockPhotoDataSource.getPhotos())
          .thenAnswer((realInvocation) => Future.value((photoList)));
    ...
    testWidgets('Should get a list of photos but gets a failure',
        (tester) async {
      //ARRANGE
      when(mockPhotoDataSource.getPhotos()).thenThrow((realInvocation) async =>
